...
class PyIndex3Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_py_index3, container, false)
        ...
        previousButton.setOnClickListener {
            (activity as? PythonActivity)?.loadFragment(PyIndex2Fragment())
        }

        // Handle "Next" button click
        nextButton.setOnClickListener {
            listener?.onIndexCompleted()
            (activity as? PythonActivity)?.loadFragment(PyQuiz3Fragment())
        }
