...
class PyIndex2Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_py_index2, container, false)
        ...
        nextButton.setOnClickListener {
            ...
            (activity as? PythonActivity)?.loadFragment(PyQuiz2Fragment())
        }
