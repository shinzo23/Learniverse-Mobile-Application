...
class PyIndex6Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_py_index6, container, false)
        ...
        previousButton.setOnClickListener {
            (activity as? PythonActivity)?.loadFragment(PyIndex5Fragment())
        }

        // Handle "Next" button click
        nextButton.setOnClickListener {
            listener?.onIndexCompleted()
            (activity as? PythonActivity)?.loadFragment(PyQuiz6Fragment())
        }
