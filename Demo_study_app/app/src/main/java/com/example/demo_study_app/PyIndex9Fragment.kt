...
class PyIndex9Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_py_index9, container, false)
        ...
        previousButton.setOnClickListener {
            (activity as? PythonActivity)?.loadFragment(PyIndex8Fragment())
        }

        // Handle "Next" button click
        nextButton.setOnClickListener {
            listener?.onIndexCompleted()
            (activity as? PythonActivity)?.loadFragment(PyQuiz9Fragment())
        }
