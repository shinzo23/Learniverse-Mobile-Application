...
class PyQuiz7Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_py_quiz7, container, false)
        ...
        submitButton.setOnClickListener {
            ...
            if (currentQuestionIndex < questions.size - 1) {
                ...
                Toast.makeText(requireContext(), "Quiz 7 Completed! Score: $score/${questions.size}", Toast.LENGTH_SHORT).show()
                (activity as PythonActivity).loadFragment(PyIndex8Fragment()) // Navigate to Index 2
            }
        }
