...
class PyIndex5Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_py_index5, container, false)
        ...
        previousButton.setOnClickListener {
            (activity as? PythonActivity)?.loadFragment(PyIndex4Fragment())
        }

        // Handle "Next" button click
        nextButton.setOnClickListener {
            listener?.onIndexCompleted()
            (activity as? PythonActivity)?.loadFragment(PyQuiz5Fragment())
        }
