...
class PyIndex11Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_py_index11, container, false)
        ...
        previousButton.setOnClickListener {
            (activity as? PythonActivity)?.loadFragment(PyIndex10Fragment())
        }

        // Handle "Next" button click
        nextButton.setOnClickListener {
            listener?.onIndexCompleted()
            (activity as? PythonActivity)?.loadFragment(PyQuiz11Fragment())
        }
